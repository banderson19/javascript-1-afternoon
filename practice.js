...
function nameCheck(name) {
  if (name === 'Steven') {
    var response = "What is up Steven?";
  } else if (name === 'Bryan' ) {
    response = "Hey Bryan!";
  } else {
    response = "Cool name, " + name
  }
  return response;
}
...
function faveColorFinder(color) {
  if (color ==='red') {
    var greeting =  'red is a great color'
  } else if (color === 'green') {
    greeting = 'green is a solid favorite color'
  } else if (color === 'black') {
    greeting = 'so trendy'
  } else {
    greeting = 'you need to evaluate your favorite color choice'
  }
  return greeting;
}
//////////////////PROBLEM 13////////////////////
